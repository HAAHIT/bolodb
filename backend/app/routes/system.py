...
from backend.app.dependencies import get_current_user, get_db, get_cfg, get_kb, get_providers
...
async def health(cfg=Depends(get_cfg), providers=Depends(get_providers), db=Depends(get_db)):
